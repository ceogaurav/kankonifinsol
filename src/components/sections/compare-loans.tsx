...
const loans: LoanRow[] = [
  ...
  },
  {
    ...
    processing: "0.50%",
    tenure: "Up to 30 yrs",
    benefits: ["Quick approval", "Top-up facility", "Digital process"],
  },
  {
    bank: "ICICI Bank",
    type: "Home Loan",
    ...
    processing: "0.50%",
    tenure: "Up to 30 yrs",
    benefits: ["Pre-approved offers", "Doorstep service", "Balance transfer"],
  },
  {
    bank: "SBI",
    type: "Home Loan",
    ...
    processing: "0.35%",
    tenure: "Up to 30 yrs",
    benefits: ["Lowest govt rates", "No hidden charges", "YONO digital"],
  },
  {
    bank: "Kotak Mahindra",
    type: "Home Loan",
    ...
    processing: "0.50%",
    tenure: "Up to 20 yrs",
    benefits: ["Fast disbursal", "Flexible tenure", "Top-up loan"],
  },
];
